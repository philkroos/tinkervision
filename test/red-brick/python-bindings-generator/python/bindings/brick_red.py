...
class BrickRED(Device):
    ...
    def vision_pause(self):
        ...
        """
        return self.ipcon.send_request(self, BrickRED.FUNCTION_VISION_PAUSE, (), '', 'i')

    def vision_restart(self):
        """
        
        """
        return self.ipcon.send_request(self, BrickRED.FUNCTION_VISION_RESTART, (), '', 'i')

    def vision_quit(self):
        """
    ...
    def vision_colormatch_start(self, id, min_hue, max_hue):
        ...
        """
        return self.ipcon.send_request(self, BrickRED.FUNCTION_VISION_COLORMATCH_START, (id, min_hue, max_hue), 'b B B', 'i')

    def vision_colormatch_stop(self, id):
        """
        
        """
        return self.ipcon.send_request(self, BrickRED.FUNCTION_VISION_COLORMATCH_STOP, (id,), 'b', 'i')

    def vision_colormatch_get(self, id):
        """
